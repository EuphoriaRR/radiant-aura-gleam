...
const FinalCTA = () => {
  const handleWhatsApp = () => {
    window.open('https://wa.me/6281369281534', '_blank');
  };

  {/* const handleEmail = () => {
    window.location.href = 'mailto:info@athelai.com';
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button 
              ...
              size="lg"
              className="bg-white text-primary hover:bg-gray-100 font-lato font-semibold text-lg px-8 py-4 h-auto flex items-center space-x-3"
            >
